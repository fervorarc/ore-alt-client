...
ORE is a Solana-native digital store of value with a capped maximum supply of 10 million tokens. It combines innovative mining mechanics with staking rewards and automated buyback mechanisms to create a trustless, decentralized cryptocurrency optimized for long-term holders.
...
- **Maximum Supply**: 10,000,000 ORE (capped)
